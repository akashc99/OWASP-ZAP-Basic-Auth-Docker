...
if [[ $1 == '' ]] || [[ $1 == '-h' ]] || [[ $1 == '--help' ]]; then
    printf "${YELLOW}[i]${END} sudo bash fullscan.sh https://example.com username password \\n"
	exit 1
fi
...
if [ $1 != '' ] || [ $2 != '' ] || [ $3 != '' ] || [ $4 != '' ]; then
	...
	#Starting ZAP Docker
	sudo docker run --rm -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-stable zap-full-scan.py -I -j -m 10 -T 60 \
	-t "${1}" \
